...
def tmpl_ChemCalcsCTS():
	...
	{% for field in form %}
		...
		{% elif field.id_for_label == "id_kow_ph" %}
			...
			<td id="id_kow_ChemAxon" class="{{form.kow_wph|color_filter:"chemaxon"}} chemaxon {{ field.id_for_label }}"></td>
			<td id="id_kow_EPI" class="{{form.kow_wph|color_filter:"epi"}} epi {{ field.id_for_label }}"></td>
			<td id="id_kow_TEST" class="{{form.kow_wph|color_filter:"test"}} test {{ field.id_for_label }}"></td>
			<td id="id_kow_SPARC" class="{{form.kow_wph|color_filter:"sparc"}} sparc {{ field.id_for_label }}"></td>
                        <td id="id_kow_MEASURED" class="{{form.kow_wph|color_filter:"measured"}} measured {{ field.id_for_label }}"></td>
		{% else %}
			<tr>
			<th class="chemprop">{{ field }} <span>{{ field.label }}</span></th>
			<td id="{{ field.id_for_label }}_ChemAxon" class="{{ field | color_filter:"chemaxon" }} chemaxon {{ field.id_for_label }}"></td>
			<td id="{{ field.id_for_label }}_EPI" class="{{ field | color_filter:"epi" }} epi {{ field.id_for_label }}"></td>
			<td id="{{ field.id_for_label }}_TEST" class="{{ field | color_filter:"test" }} test {{ field.id_for_label }}"></td>
			<td id="{{ field.id_for_label }}_SPARC" class="{{ field | color_filter:"sparc" }} sparc {{ field.id_for_label }}"></td>
                        <td id="{{ field.id_for_label }}_MEASURED" class="{{ field | color_filter:"measured" }} measured {{ field.id_for_label }}"></td>
			</tr>
		{% endif %}
	{% endfor %}
		<tr>
